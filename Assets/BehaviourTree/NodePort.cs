...
//Makes connecting nodes more fluid
    public class NodePort : Port {

    // Source from:/Unity-Technologies/UnityCsReference/blob/master/Modules/GraphViewEditor/Elements/Port.cs
    private class DefaultEdgeConnectorListener : IEdgeConnectorListener {
            ...
            public void OnDrop(GraphView graphView, Edge edge) {
                ...
                if (edge.input.capacity == Capacity.Single)
                    foreach (Edge edgeToDelete in edge.input.connections)
                        if (edgeToDelete != edge) m_EdgesToDelete.Add(edgeToDelete);
        ...
        }else
        {
            ...
            style.backgroundColor = new Color(0f, 0f, 0f, 0.1f);
        }
